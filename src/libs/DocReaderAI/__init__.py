...
class DocReaderAI:
    ...
    def __init__(self):
        ...
        # self.pdf_worker.add_pdf(pdf_path=path+"/src/libs/DocReaderAI/DocDocument/Document/hasan_ozkul.pdf",
        #                         pdf_definition="Hasan Özkul's resume",
        #                         user_uuid=1,
        #                         document_uuid=1)
        #
        # print(pdf_worker.get_retriever_by_document_uuid(1))
        # self.pdf_worker.add_pdf(pdf_path=path+"/src/libs/DocReaderAI/DocDocument/Document/RamazanBurakKorkmaz_16072023.pdf",
